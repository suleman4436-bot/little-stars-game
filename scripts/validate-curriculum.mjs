...
for (const value of ['Count the Stars', 'Color Garden', 'Shape Safari', 'Big or Small', 'Numbers', 'Colors', 'Shapes', 'Thinking', 'counting', 'sorting', 'matching-pairs']) assert.match(source, new RegExp(value));
for (const value of ['ستارے گنیں', 'رنگوں کا باغ', 'اشکال کی سیر', 'بڑا یا چھوٹا', 'گنتی', 'رنگ', 'اشکال', 'سوچ اور سمجھ']) assert.match(source, new RegExp(value));
